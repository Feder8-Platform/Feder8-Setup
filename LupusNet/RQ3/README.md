# How to execute Research Question 3 (RQ3)
...
2. Download the 'RQ3 treatment trajectories' run script:
    ...
    * Windows:
      ```
      curl -L https://raw.githubusercontent.com/Feder8-Platform/Feder8-Setup/main/LupusNet/RQ3/run-rq3-treatment-trajectories.cmd --output run-rq3-treatment-trajectories.cmd
      ```
3. Execute the script (from the directory where the script is downloaded)
    ...
    * Windows:
      ```
      run-rq3-treatment-trajectories.cmd
      ```
