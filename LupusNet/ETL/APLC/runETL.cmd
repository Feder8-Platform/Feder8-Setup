...
docker run --rm --network feder8-net --env DB_USER=%db_username% --env DB_PASSWORD=%db_password% -v %data_folder%:/script/etl/data -v %reports_folder%:/script/etl/aplc/reports %REGISTRY%/%REPOSITORY%/%IMAGE%:%TAG%
