...
echo "LOG_FOLDER=/script/etl/aplc/log" >> etl-runner.env
echo "ETL_IMAGE_NAME=etl-aplc/etl" >> etl-runner.env
...
echo "QA_FOLDER_ETL=/script/etl/aplc/reports" >> etl-runner.env
