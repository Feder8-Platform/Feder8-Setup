...
export CLINICAL_IMAGE="${EVAL_IMAGE:-harbor.honeur.org/honeur/clinical-notes-processor:0.8.0}"
...
case "${ver}" in
  0.0.*|0.1.*)
    ...
    echo "       Pin CLINICAL_IMAGE to :0.8.0 (or later) in .env, run 'docker compose pull', and retry." >&2
