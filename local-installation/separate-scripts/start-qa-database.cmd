...
curl -fsSL https://raw.githubusercontent.com/Feder8-Platform/Feder8-Setup/main/local-installation/separate-scripts/start-source-creation.cmd --output start-source-creation.cmd
SET FEDER8_SHARED_SECRETS_VOLUME_NAME=shared-qa
