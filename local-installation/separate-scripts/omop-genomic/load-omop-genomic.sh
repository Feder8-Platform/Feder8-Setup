...
curl -fsSL https://raw.githubusercontent.com/Feder8-Platform/Feder8-Setup/main/local-installation/separate-scripts/omop-genomic/omop-genomic.zip --output omop-genomic.zip
